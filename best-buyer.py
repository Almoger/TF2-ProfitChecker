...
def scan_single_item(base_name: str, quality_id: int, scm_ils: float):
...
if __name__ == "__main__":
    while True:
        try:
            ...
            scm_price_str = input("Enter how much money you spent in ILS: ").strip()
            scm_price = float(scm_price_str)
        ...
        result = scan_single_item(base_name, quality_id, scm_price)
